...
public class FXMLActivitiesOptionController implements Initializable, DeveloperObserver{
    ...
    private void btnEditActivity(ActionEvent event) {
        try {
            ...
            Activity selectedActivity = tvUnassignedActivities.getSelectionModel().getSelectedItem();
            ...
            Logger.getLogger(FXMLActivitiesOptionController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
