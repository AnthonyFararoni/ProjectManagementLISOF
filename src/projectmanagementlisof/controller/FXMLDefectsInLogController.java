...
public class FXMLDefectsInLogController implements Initializable
{
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tvLogDefects.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
    ...
    private void configureDefectsTable() {
        ...
        colTimeCost.setCellValueFactory(cellData -> new SimpleIntegerProperty(cellData.getValue().getTimeCost()).asObject());
        colDateFound.setCellValueFactory(data -> new SimpleStringProperty(data.getValue().getDate()));
